...
export const CustomTooltip = React.forwardRef<HTMLElement, CustomTooltipProps>(
  (
    { content, children, className, delay = 200, offset = { x: 8, y: -8 } },
    ref
  ) => {

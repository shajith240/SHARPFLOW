...
export function AIAssistantInterface() {
  ...
  const commandSuggestions = {
    generate: [
      "Find coffee shop owners in Paris",
      "Generate leads for dental clinics in New York",
      "Search for restaurant managers in London",
      "Find gym owners in Los Angeles",
      "Generate leads for tech startups in Berlin",
    ],
    research: [
      "Research this LinkedIn profile: linkedin.com/in/johndoe",
      "Analyze company background for lead qualification",
      "Research competitor analysis for outreach strategy",
      "Generate company insights for personalized messaging",
      "Research industry trends for better targeting",
    ],
    outreach: [
      "Generate personalized email for lead ID 123",
      "Create LinkedIn connection message template",
      "Draft follow-up email sequence",
      "Write cold outreach message for restaurant owners",
      "Create personalized proposal for tech company",
    ],
  };
      ...
      <div className="w-full max-w-3xl mx-auto flex flex-col items-center">
        ...
        <div className="mb-10 text-center">
          ...
          >
            ...
            <p className="text-gray-500 max-w-md">
              Your central AI assistant coordinating Falcon, Sage, and Sentinel
              agents for comprehensive lead generation
            </p>
          </motion.div>
        </div>
        ...
        <div className="w-full grid grid-cols-3 gap-4 mb-4">
          <CommandButton
            ...
            label="Generate"
            isActive={activeCommandCategory === "generate"}
            onClick={() =>
              setActiveCommandCategory(
                activeCommandCategory === "generate" ? null : "generate"
              )
            }
          />
          <CommandButton
            ...
            onClick={() =>
              setActiveCommandCategory(
                activeCommandCategory === "research" ? null : "research"
              )
            }
          />
          <CommandButton
            ...
            label="Outreach"
            isActive={activeCommandCategory === "outreach"}
            onClick={() =>
              setActiveCommandCategory(
                activeCommandCategory === "outreach" ? null : "outreach"
              )
            }
          />
        </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                <div className="p-3 border-b border-gray-100">
                  <h3 className="text-sm font-medium text-gray-700">
                    {activeCommandCategory === "generate"
                      ? "Lead Generation suggestions"
                      : activeCommandCategory === "research"
